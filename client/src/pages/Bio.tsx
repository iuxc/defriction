...
export default function Bio() {
  ...
  return (
    <div className="bg-deep-basalt text-white selection:bg-volt-lime selection:text-black font-sans">
      <Navigation />
      ...
      <div ref={containerRef} className="h-screen overflow-y-scroll snap-y snap-mandatory scroll-smooth no-scrollbar">
        ...
        {/* Section 1: Hero */}
        <section className="h-screen snap-start w-full relative flex items-center justify-center overflow-hidden">
          ...
          <motion.div 
            ...
            className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-gray-500 font-mono text-xs uppercase tracking-widest animate-bounce"
          >
            Scroll
        ...
        <section className="h-screen snap-start w-full relative flex items-center justify-center bg-black/20">
          <div className="container mx-auto px-4 grid md:grid-cols-12 gap-12 items-center h-full">
        ...
        <section className="h-screen snap-start w-full relative flex flex-col justify-center bg-deep-basalt">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[60vh]">
              {[
                ...
                <motion.div 
                  ...
                  viewport={{ once: true }}
                  className={`group relative p-8 bg-white/5 hover:bg-white/10 transition-all duration-500 flex flex-col justify-between border-l-4 ${item.color}`}
                >
        ...
        {/* Section 4: The Value */}
        <section className="h-screen snap-start w-full relative flex items-center justify-center">
          <div className="absolute inset-0 bg-gradient-to-b from-deep-basalt to-black" />
          ...
          <div className="container mx-auto px-4 relative z-10 grid md:grid-cols-2 h-full">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="flex flex-col justify-center p-12 md:p-24 border-r border-white/10 group hover:bg-white/5 transition-colors duration-700"
            >
            ...
            <motion.div 
              ...
              transition={{ duration: 0.8, delay: 0.2 }}
              viewport={{ once: true }}
              className="flex flex-col justify-center p-12 md:p-24 group hover:bg-white/5 transition-colors duration-700"
            >
        ...
        {/* Section 5: The Human */}
        <section className="h-screen snap-start w-full relative flex items-center justify-center bg-black overflow-hidden">
        ...
        <section className="h-screen snap-start w-full relative flex items-center justify-center bg-deep-basalt">
