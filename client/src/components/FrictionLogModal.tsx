          ...
          <div className="p-8 max-w-3xl mx-auto pb-24">
            ...
            <div className="space-y-8 px-8">
              ...
              <section className="grid grid-cols-[max-content_1fr] gap-x-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-6">
                    <div>
                        <h4 className="font-bold text-slate-200 mb-2">Observation</h4>
                        <p className="text-slate-400 text-sm">No specific "Pathways" or "TAFE" entry point is visible on the main landing page; navigation assumes a standard starting point.</p>
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section className="grid grid-cols-[max-content_1fr] gap-x-4">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-xl font-bold text-white">Bachelor of Nursing Course Page</h3>
                    <div className="text-sm text-slate-400 font-mono mt-1">
              ...
              {/* Step 3 */}
               <section className="grid grid-cols-[max-content_1fr] gap-x-4">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-xl font-bold text-white">VET/TAFE Entry Section</h3>
                    <div className="text-sm text-slate-400 font-mono mt-1">
              ...
              <section className="grid grid-cols-[max-content_1fr] gap-x-4">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-xl font-bold text-white">Credit Search Tool</h3>
                    <div className="text-sm text-slate-400 font-mono mt-1">
              ...
              <section className="grid grid-cols-[max-content_1fr] gap-x-4">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-xl font-bold text-white">Nursing Pathways Page</h3>
                    <div className="text-sm text-slate-400 font-mono mt-1">
              ...
              <section className="grid grid-cols-[max-content_1fr] gap-x-4">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-xl font-bold text-white">VTAC Course Search (External)</h3>
                    <div className="text-sm text-slate-400 font-mono mt-1">
                      ...
                      <div>
                        ...
                        <ul className="space-y-4">
                          <li className="text-sm text-slate-300">
                            <strong className="block font-semibold text-red-400 mb-1">Conflicting Advice</strong>
                            The website contradicts itself on whether a TAFE graduate needs a "Pathways" year (DoTS) or can apply for direct entry.
                          </li>
                          <li className="text-sm text-slate-300">
                            <strong className="block font-semibold text-red-400 mb-1">Credit Dead-ends</strong>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h3 className="font-bold text-slate-200 mb-4">
                         ...
                         <ul className="space-y-4">
                          <li className="text-sm text-slate-300">
                            <strong className="block font-semibold text-slate-200 mb-1">Specific Unit Credit</strong>
                            No clear list of which units are waived for a standard Diploma of Nursing.
                          </li>
                          <li className="text-sm text-slate-300">
                            <strong className="block font-semibold text-slate-200 mb-1">Exclusion Clarity</strong>
