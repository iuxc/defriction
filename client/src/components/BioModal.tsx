...
export function BioModal({ open, onOpenChange }: BioModalProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl w-screen h-screen md:h-auto md:w-full bg-deep-basalt border-0 md:border md:border-white/10 text-white p-0 overflow-hidden md:rounded-3xl max-h-screen md:max-h-[90vh] overflow-y-auto m-0 rounded-none data-[state=open]:duration-700 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=closed]:duration-500 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
